...
/* harmony import */ var vendor_smooth_scrollbar_ScrollTriggerPlugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vendor/smooth-scrollbar/ScrollTriggerPlugin */ "./src/js/vendor/smooth-scrollbar/ScrollTriggerPlugin.js");
/* harmony import */ var vendor_smooth_scrollbar_SoftScrollPlugin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vendor/smooth-scrollbar/SoftScrollPlugin */ "./src/js/vendor/smooth-scrollbar/SoftScrollPlugin.js");
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var utills__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! utills */ "./src/js/utills.js");
/*** IMPORTS FROM imports-loader ***/var define=false;// GSAP ScrollTrigger & Soft Edges plugin for SmoothScroll
smooth_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"].use(vendor_smooth_scrollbar_ScrollTriggerPlugin__WEBPACK_IMPORTED_MODULE_1__["default"],vendor_smooth_scrollbar_SoftScrollPlugin__WEBPACK_IMPORTED_MODULE_2__["default"]);window.SmoothScrollbar=smooth_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"];// console.dir(window)
...
/*!**************************!*\
  !*** ./src/js/utills.js ***!
  \**************************/
/*! exports provided: preloadImage, preloadImages, calcDrawImage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function _inheritsLoose(subClass,superClass){subClass.prototype=Object.create(superClass.prototype);subClass.prototype.constructor=subClass;_setPrototypeOf(subClass,superClass);}function _setPrototypeOf(o,p){_setPrototypeOf=Object.setPrototypeOf?Object.setPrototypeOf.bind():function _setPrototypeOf(o,p){o.__proto__=p;return o;};return _setPrototypeOf(o,p);}/*** IMPORTS FROM imports-loader ***/var define=false;/*!
 * SmoothScrollbar GSAP ScrollTrigger Plugin
 *
 * @version 1.0.1
 * @author Artem Dordzhiev (Draft)
 */gsap__WEBPACK_IMPORTED_MODULE_1__["default"].registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"]);var ScrollTriggerPlugin=/*#__PURE__*/function(_Scrollbar$ScrollbarP){_inheritsLoose(ScrollTriggerPlugin,_Scrollbar$ScrollbarP);function ScrollTriggerPlugin(scrollbar,options){var _this;_this=_Scrollbar$ScrollbarP.call(this,scrollbar,options)||this;_this.setProxy();return _this;}var _proto=ScrollTriggerPlugin.prototype;_proto.setProxy=function setProxy(){var scrollbar=this.scrollbar;gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"].scrollerProxy(document.body,{scrollTop:function scrollTop(value){if(arguments.length){scrollbar.scrollTop=value;// setter
}return scrollbar.scrollTop;// getter
},getBoundingClientRect:function getBoundingClientRect(){return{top:0,left:0,width:window.innerWidth,height:window.innerHeight};},pinType:"transform"});scrollbar.addListener(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"].update);};return ScrollTriggerPlugin;}(smooth_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"].ScrollbarPlugin);ScrollTriggerPlugin.pluginName='ScrollTrigger';/* harmony default export */ __webpack_exports__["default"] = (ScrollTriggerPlugin);

/***/ }),

/***/ "./src/js/vendor/smooth-scrollbar/SoftScrollPlugin.js":
/*!************************************************************!*\
  !*** ./src/js/vendor/smooth-scrollbar/SoftScrollPlugin.js ***!
  \************************************************************/
/*! exports provided: default */
 ...
 */var SoftScrollPlugin=/*#__PURE__*/function(_Scrollbar$ScrollbarP){_inheritsLoose(SoftScrollPlugin,_Scrollbar$ScrollbarP);function SoftScrollPlugin(){return _Scrollbar$ScrollbarP.apply(this,arguments)||this;}var _proto=SoftScrollPlugin.prototype;_proto.transformDelta=function transformDelta(delta,fromEvent){var dirX=delta.x>0?1:-1;var dirY=delta.y>0?1:-1;if(dirX===this.lockX||dirY===this.lockY){return{x:0,y:0};}else{this.lockX=null;this.lockY=null;}return delta;};_proto.onRender=function onRender(Data2d){var x=Data2d.x,y=Data2d.y;// Up
if(y<0&&!this.lockY&&Math.abs(y)>=this.scrollbar.scrollTop){this.scrollbar.setMomentum(0,-this.scrollbar.scrollTop);this.lockY=-1;}// Left
if(x<0&&!this.lockX&&Math.abs(x)>=this.scrollbar.scrollLeft){this.scrollbar.setMomentum(-this.scrollbar.scrollLeft,0);this.lockX=-1;}// Right
if(x>0&&!this.lockX&&Math.abs(x)>=this.scrollbar.limit.x-this.scrollbar.scrollLeft){this.scrollbar.setMomentum(this.scrollbar.limit.x-this.scrollbar.scrollLeft,0);this.lockX=1;}// Down
if(y>0&&!this.lockY&&Math.abs(y)>=this.scrollbar.limit.y-this.scrollbar.scrollTop){this.scrollbar.setMomentum(0,this.scrollbar.limit.y-this.scrollbar.scrollTop);this.lockY=1;}if(y===0)this.lockY=null;if(x===0)this.lockX=null;};return SoftScrollPlugin;}(smooth_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"].ScrollbarPlugin);SoftScrollPlugin.pluginName='SoftScroll';/* harmony default export */ __webpack_exports__["default"] = (SoftScrollPlugin);
